...
exports.login = async (req, res) => {
  ...
  res.json({ ok: true, user: safeUser(user), redirectTo: user.role === 'homecook' ? '/cook-dashboard' : '/customer-dashboard' });
};
